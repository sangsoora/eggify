                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div id="iconPicker" class="modal fade">
                              <div class="modal-dialog" style="max-width: 1140px; min-height: 1200px;">
...
$(icons).each(function(index) {
  ...
  var itemtemp = '';
  itemtemp = `<li><a class="text-center" data-class="` + item + ' ' + activeState + `" data-index="` + index + `"><span class="` + item + `"></span><span class="name-class">` + item + `</span></a></li>`

...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">@lang('admin.menu.producer')</li>
        </ol>
    </nav>
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">@lang('admin.page.producer.title')</h6>
                    <p class="card-description">@lang('admin.page.producer.description')</p>

                    <div class="mb-3 float-right">
                        <a href="{{ route('admin.producer.create') }}" class="btn btn-primary btn-icon-text">
    ...
    <script>
        $(function () {
            $('#dataTable').DataTable({
                ...
                serverSide: true,
                stateSave: true,
                ajax: '{{ route('admin.producer.data') }}',
                order: [],
                oLanguage: {

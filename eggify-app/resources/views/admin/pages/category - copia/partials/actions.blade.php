...
<button type="button" onclick="window.location='{{ route('admin.order.edit', $id) }}'" class="btn btn-primary btn-icon" data-toggle="tooltip" data-placement="top" title="@lang('global.general.edit')">
    <i data-feather="edit"></i>
</button>

{!! Form::open(['route' => ['admin.order.destroy', $id], 'method' => 'DELETE', 'class' => 'd-inline']) !!}

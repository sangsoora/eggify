...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">{{ sprintf('%s - %s', trans('admin.menu.users_admin'), trans('global.general.edit')) }}</h6>
                    {!! Form::open(['method' => 'PUT','route' => ['admin.usersadmin.update', $user->id]])!!}
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('name', trans('admin.page.users-admin.table.name')) !!}
                                {!! Form::input('text', 'name', $user->name, ['id' => 'name', 'class' => 'form-control', 'placeholder' => trans('admin.page.users-admin.table.name'), 'required']) !!}
                            </div>
                        </div><!-- Col -->
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('user_type_id', trans('admin.page.users-admin.table.user_type')) !!}
                                {!! Form::select('user_type_id', $usertype->pluck('name', 'id'), $user->user_type->id, ['class' => 'form-control', 'id' => 'user_type_id', 'required']) !!}
                            </div>
                        </div><!-- Col -->
                        <div class="col-sm-3">
                            <div class="form-group">
